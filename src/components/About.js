...
function About() {
  ...
  return (
    ...
    <div>
      ...
      <p className='w-25'>
      Hi, My name is Joey. Working with computers and sound has been a craft for sometime. Previous work experiences have been in IT hardware support and sales. My career path will be moving towards software development.
      </p>
      </div>
